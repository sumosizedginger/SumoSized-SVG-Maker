# Walkthrough - Professional Text Fitting

I have refined the **Advanced Text** generator to ensure text fits professionally within the window and does not bleed out of the canvas bounds.
...
- **"Breathing Spiral" Fix**: Doubled the growth rate of the spiral coils. This ensures that letters have enough vertical breathing room and do not overlap between rings.
...
2.  Select the **Advanced Text** generator.
3.  Choose the **Spiral** effect.
4.  Observe that the text now fits comfortably within the canvas without being cut off.
...
````carousel
![The Crying Skull Masterpiece](../media/crying_skull_masterpiece_1772742886516.png)
<!-- slide -->
```javascript
// The API calls used to build this:
SumoSvgApp.clearLayers();
SumoSvgApp.addLayer('sacred-geometry', { complexity: 8, sacredScale: 1.2, color: '#FFD700' });
SumoSvgApp.addLayer('svg-import', { svgData: skullSvg });
SumoSvgApp.addLayer('free-draw', { pathData: 'white;0.5;round;M38 48 Q40 60 38 75|M62 48 Q60 60 62 75' });
SumoSvgApp.addLayer('text-effects', { content: 'HERE THERE BE DRAGONS!', effect: 'spiral', color: '#FF4500' });
```
````
...
![Animated Blinking Skull](../media/blinking_crying_skull_1772743115544.webp)
...
![Text with Thick Red Border](../media/blinking_skull_initial_1772743147308.png)
...
![Verified Build Output](/../media/matrix_rain_parameters_1772746337588.png)
