...
SumoSized SVG Generator is built on a strict **Domain-Driven Design (DDD)** architecture. This means the SvelteKit frontend is merely a _viewer_ for a completely decoupled, pure TypeScript mathematical generation matrix.
