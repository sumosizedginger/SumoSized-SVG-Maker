 ...
 */
export function logRender(generatorId: string, durationMs: number, paramHash?: string) {
 ...
 */
export function logError(generatorId: string, errorCode: string, details?: string) {
