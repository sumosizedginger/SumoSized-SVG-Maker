...
export const symbolGrid: SVGGenerator = {
    ...
    version: '1.0.0',
    params: [
        { name: 'cells', label: 'Cells', type: 'integer', min: 2, max: 20, step: 1, default: 8, group: 'Layout' },
        { name: 'padding', label: 'Cell Padding', type: 'number', min: 0, max: 0.4, step: 0.05, default: 0.2, group: 'Layout' },
        { name: 'thickness', label: 'Stroke Weight', type: 'number', min: 0.5, max: 5, step: 0.1, default: 1.5, group: 'Style' },
        { name: 'bgColor', label: 'Background', type: 'color', default: '#ffffff', group: 'Colors' },
        { name: 'color', label: 'Symbol Color', type: 'color', default: '#333333', group: 'Colors' },
        { name: 'variety', label: 'Variety', type: 'number', min: 0, max: 1, step: 0.1, default: 0.5, group: 'Style' },
        { name: 'transparent', label: 'Transparent Background', type: 'boolean', default: false, group: 'Background' }
    ],
    defaultParams: { cells: 8, padding: 0.2, thickness: 1.5, bgColor: '#ffffff', color: '#333333', variety: 0.5, transparent: false },
    render: (params, seed) => {
        const { cells, padding, thickness, bgColor, color, variety, transparent } = params;
