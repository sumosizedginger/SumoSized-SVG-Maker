...
export const sacredGeometryGenerator: SVGGenerator = {
    ...
    description: 'Standalone sacred geometric matrices (Metatron Cube, Seed of Life) optimized for stacking and overlaying.',
    category: 'Abstract',
    ...
    render: (params, seed) => {
        ...
        const filterAttr = glowIntensity > 0 ? `filter="url(#sacred-glow-${seed})"` : '';
        ...
        else if (sacredMode === 'Hyper-Toroid') {
            const count = 72;
            const ringRadius = 18;
