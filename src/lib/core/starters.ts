...
export const STARTER_TEMPLATES: StarterTemplate[] = [
    {
        ...
        layers: [
            ...
            },
            {
                ...
                name: 'Metatron Nexus',
                params: { sacredMode: 'Metatron Cube', glowIntensity: 12, lineWidth: 0.2 },
                blendMode: 'screen'
            }
        ]
    },
    {
        ...
        layers: [
            ...
            },
            {
                ...
                name: 'Energy Flow',
                params: { count: 180, steps: 40, complexity: 0.08, lineColor: '#f43f5e' },
                opacity: 0.8,
                blendMode: 'screen'
            }
        ]
    ...
    },
    {
        ...
        layers: [
            ...
            },
            {
                ...
                name: 'Core Resonance',
                params: { complexity: 40, symmetry: 8, glowIntensity: 15, frequencyRatio: 1.33 }
            }
        ]
    }
];
